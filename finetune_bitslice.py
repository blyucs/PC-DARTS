...
parser.add_argument('--load-dir', type=str, default='eval-EXP-20211224-211028', help='experiment name')
...
def infer(valid_queue, model, criterion):
  ...
  with torch.no_grad():    
    for step, (input, target) in enumerate(valid_queue):
      ...
      if step % args.report_freq == 0:
        logging.info('valid %03d %e %f %f', step, objs.avg, top1.avg, top5.avg, z1, z2, z3, z4)
